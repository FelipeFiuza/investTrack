...
public class ApuracaoIndiceDTO {
    ...
    public ApuracaoIndiceDTO() {}

    public ApuracaoIndiceDTO(Long codIndice, LocalDateTime dataApuracao, BigDecimal valorAbertura,
    ...
    public LocalDateTime getDataApuracao() { return dataApuracao; }
    public void setDataApuracao(LocalDateTime dataApuracao) { this.dataApuracao = dataApuracao; }
